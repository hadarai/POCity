...
namespace POCity.Properties
{
    public partial class Map
    {
        ...
        public void PostawElektrownie(int x, int y)
        {
            ...
            {
                PowerPlant temp = new PowerPlant(x,
                                                 y,
        ...
        public void PostawPolicje(int x, int y)
        {
            if (CzyMogeTuCokolwiek(x, y) && CzyObokJestDroga(x, y))
            {
                Police temp = new Police(x, y, NajkrotszaOdleglosc(WiezeCisnien, x, y) < PromienWody, NajkrotszaOdleglosc(Elektrownie, x, y) < PromienPradu);
        ...
        public void PostawSzpital(int x, int y)
        {
            if (CzyMogeTuCokolwiek(x, y) && CzyObokJestDroga(x, y))
            {
                Healthcare temp = new Healthcare(x,
                                                 y,
                                                 NajkrotszaOdleglosc(WiezeCisnien, x, y) < PromienWody,
                                                 NajkrotszaOdleglosc(Elektrownie, x, y) < PromienPradu);
